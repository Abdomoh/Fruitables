                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <form action="{{ route('register') }}" class="" method="POST">
                                @csrf
                                <input type="text" name="name" class="w-100 form-control border-0 py-3 mb-4" placeholder="Your Name"  value="{{ old('name') }}">
                                <x-input-error :messages="$errors->get('name')" class="mt-2  text-danger" />
                                <input type="email" name="email" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your Email"  value="{{ old('email') }}">
