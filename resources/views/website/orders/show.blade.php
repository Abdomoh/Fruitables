...
@section('content')
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">{{ trans('main.invoice_detels') }}</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/orders') }}">/ &nbsp;&nbsp;{{ trans('main.dashboard') }}
                        </a></li>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             @else <span class="text-success">{{ $order->status }}</span>
                                              @endif
                                            </td>
                                        </tr>
                                        <tr>
...
<br>
                            <h3 class="summary-title text-center">{{ trans('main.product_detels') }} </h3>
                            <tr>
                                <table class="table  table-container">
                                    <tr>
        ...
        <center>
            <br>
            <div class=" fa fa-print"  class="center-div" onclick="printDiv('printableArea')">
                <p>{{ __('main.print') }}</p>
            </div>
        </center>
    </main><!-- End .main -->
